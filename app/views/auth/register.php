<section class="section-register">
  ...
  <div class="d-flex flex-wrap container shadow-lg rounded p-5">
    <div class="logo-register-container mx-auto">
      <img class="mw-100 h-auto object-fit-md-none object-fit-fill" src="<?php echo APP_URL; ?>app/views/img/logo.png" alt="logo">
    </div>
    <form class="d-flex flex-column flex-grow-1 mx-md-5" autocomplete="off" id="form-register-user">
      ...
      <div class="form-group mb-3">
        ...
        <input type="password" class="form-control " name="password" placeholder="Debe contener al menos un símbolo y una mayúscula">
      ...
      <div class="modal-content">
        <div class="modal-body">
          <div class="gif-modal mx-auto">
            <img class="mw-100 h-auto object-fit-md-none object-fit-fill" src="<?php echo APP_URL; ?>app/views/img/confetti.gif" alt="coonfetti">
          </div>
          <h6>
            Felicidades ya puedes empezar a realizar tus pedidos y disfrutar de nuestros productos!!!!
          </h6>
        </div>
